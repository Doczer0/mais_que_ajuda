...
public class AppConfig {
    ...
    //URL's POST
    public static final String URL_LOGIN = "http://191.252.113.109:4000/api/authentication";
    public static final String URL_REGISTER = "http://191.252.113.109:4000/api/users";

    //URL's GET
    public static final String URL_CATEGORIES = "http://191.252.113.109:4000/api/categories";
    public static final String URL_EXERCISES = "http://191.252.113.109:4000/api/exercises";
    public static final String URL_STAGES = "http://191.252.113.109:4000/api/steps";
    public static final String URL_EXERCISE_IMG = "http://191.252.113.109:4000/api/comparisons";
